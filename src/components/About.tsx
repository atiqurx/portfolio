      ...
      <section className="flex flex-col md:flex-row gap-10 mt-6">
        ...
        <div className="w-full md:w-[60%]">
          ...
          <p className="mt-4 text-white/70 leading-relaxed text-[13px]">
            I'm currently pursuing a degree in Computer Science at UT Arlington,
            where I've developed a strong foundation in software engineering and
            a passion for building meaningful products. With a unique blend of
            technical ability and leadership experience, I thrive in
          ...
          <p className="mt-4 text-white/70 leading-relaxed text-[13px]">
            ...
            Outside of work, I draw inspiration from music, nature, and everyday
            interactions—fueling both my creativity and curiosity as a
            developer.
          </p>

          {/* Buttons */}
          <div className="flex flex-wrap gap-4 mt-6">
            <Link href="mailto:axr0966@mavs.uta.edu" target="_blank">
            ...
            <Link href="https://github.com/atiqurx" target="_blank">
              <button className="flex bg-[rgb(22,23,26)] items-center gap-2 border border-white/20 px-4 py-[4px] rounded-[3px] hover:bg-white/10 transition text-[13px] cursor-pointer">
                <FaGithub className="w-4 h-4" />
                Github
              </button>
            </Link>
            <Link href="https://linkedin.com/in/atiqurx" target="_blank">
      ...
      <section className="flex flex-col md:flex-row gap-6 mt-16">
        ...
        <div className="w-full md:w-[50%]">
          ...
          <EducationCard
            ...
            description="Relevant Coursework: Data Structures & Algorithms, Linear Algebra, Discrete Structures, Object OrientedProgramming, Software Testing. Awards & Honors: HackTX ‘24, HackUTA 6, HackSMU VI, Dean’s List, Freshman Distinction Roll"
            startDate="Aug. 2022"
            endDate="May 2026"
