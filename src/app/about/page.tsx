...
const AboutPage: React.FC = () => {
  return (
    <section>
      <div
        className="text-[3rem] bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600 text-center font-sans font-bold"
      ...
      <div
        className="flex flex-col lg:flex-row justify-between w-3/4 mx-auto"
        style={{ gap: "2rem" }}
      >
